...
do
  ...
  TRAINING_ARGS="--vel_norm_norm --batch_size 8 --sub_batch_size 1 --val_batch_size 1 --lr 5e-4 --use_adam --num_epochs 400 --lr_decay_factor 0.5 --lr_decay_steps 200 --normalize_kl --normalize_nll --tune_on_nll --val_teacher_forcing --teacher_forcing_steps -1 --train_data_len 100"
  ...
  EVAL_ARGS="--report_error_norm --vel_norm_norm --train_data_len 100 --batch_size 1 --max_burn_in_count 5 --verbose --final_test --test_short_sequences --error_out_name test_prediction_errors_shortseq_burnin5.npy --load_best_model"
